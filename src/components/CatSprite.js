...
import { useCatSprite } from "./useCatSprite";
export default function CatSprite() {
  const { msg, messageRef, spriteRef, thinkMsg, toggleSprite, handleDragStart, handleDragStop, costume } = useCatSprite();
  return (
    <div ref={spriteRef}>
      {msg &&
        <div ref={messageRef}>
          <div className="relative inline-block ml-20 mt-10">

            <div className="check relative inline-block p-2 border border-gray-300 rounded-md mb-2">
              {msg}
              <div className="absolute left-0 bottom-0 w-full h-2 bg-white">
                <svg
                ...
                >
                  <path
                    fill="#e5e7eb"  // Matching the gray-300 color of the border
                    d="M0,96L80,80C160,64,320,32,480,48C640,64,800,128,960,144C1120,160,1280,128,1360,112L1440,96V160H1360C1280,160,1120,160,960,160C800,160,640,160,480,160C320,160,160,160,80,160H0Z"
                  />
                </svg>
              </div>
            </div>
      ...
      {toggleSprite &&
        <Draggable onStart={handleDragStart}
          onStop={handleDragStop} bounds="parent">
          <svg
            ...
            version="1.1"
            xmlSpace="preserve"
            style={{ cursor: 'move', zIndex: 1000, position: 'absolute' }}
          >
            <g>
